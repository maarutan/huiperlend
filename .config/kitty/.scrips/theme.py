...
kitty_conf_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir))
colorscheme_path = os.path.join(kitty_conf_dir, ".colorscheme")
cache_dir = os.path.join(kitty_conf_dir, ".cache")
theme_file = os.path.join(colorscheme_path, "theme.conf")
